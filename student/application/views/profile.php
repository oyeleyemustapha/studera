                                        ...
                                        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                                            ...
                                            <form method="post" action="<?php echo base_url(); ?>updatePassword">
                                                <div class="form-group">
                                                    <input type="password" class="input-lg form-control" name="password" placeholder="Password" required>
                                                </div>
                                                <div class="form-group">
                                                    <input type="password" class="input-lg form-control" name="confirmpassword" placeholder="Confirm Password" required>
                                                </div>
                                                <div class="form-group">
