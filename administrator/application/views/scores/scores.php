      ...
      <div class="row">
        <div class="white-box banner">
          <div class="btn-group">
            ...
            <button class="btn btn-warning btn-lg" data-toggle="modal" href='#scoresheetModal'><i class="fa fa-file-text-o fa-fw"></i>Score sheet</button>
                ...
                <form id="addscoresform" method="post">
                   ...
                   <div class="form-group">
                          <div class="input-group">
                            ...
                            <select class="form-control subjectslist" name="subject" id="subjects" style="width: 100%" required>
                              <option></option>
                            </select>
                          </div>
                    </div>
...
<div class="modal fade" id="addSingleScoresModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addscoresform" method="post" action="admin/process_singleScore">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>gradelist" method="post" target="_blank">
                   <div class="form-group">
                          <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-fw fa-book"></i>SUBJECT</div>
                            <select class="form-control" name="subject" id="subjects" style="width: 100%" required>
                              <option></option>
                            </select>
                          </div>
                    </div>
...
<!--====SCORESHEET MODAL==-->
<div class="modal fade" id="scoresheetModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title text-center">Generate Score Sheet</h4>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>scoresheet" method="post" target="_blank">
                   <div class="form-group">
                          <div class="input-group">
                   ...
                   <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-building fa-fw"></i>PRESENT CLASS</div>
                             <select class="form-control input-lg classes" name="presentClass" style="width: 100%" required>
                                <option value="">Select Class</option>
                                <?php echo classes();?>
                            </select>
                        </div>
