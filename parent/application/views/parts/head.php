        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic " class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user-circle-o fa-2x fa-fw "></i> Mr &amp; Mrs '.$student_info->SURNAME.' <span class="caret"></span></a>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li style="padding: 10px 0 0;">
                        <a href="'.base_url().'performance.html" class="waves-effect"><i class="fa fa-pie-chart fa-fw" aria-hidden="true"></i><span class="hide-menu">Performance</span></a>
                    </li>
